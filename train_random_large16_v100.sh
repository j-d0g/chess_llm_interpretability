...
echo "🎲 Creating and training probes on RANDOM WEIGHTS large-16 model"
echo "Starting at $(date)"

# Create properly randomized version of large-16 model
python -c "
import torch
import numpy as np
...
print('🎲 Loading original large-16 model...')
...
echo "🧪 Training probes on randomized large-16 model..."
...
echo "✅ Random large-16 probe training completed at $(date)"