#!/bin/bash
#SBATCH --job-name=random_small24
...
#SBATCH --output=logs/random_small24_%j.out
#SBATCH --error=logs/random_small24_%j.err
...
echo "🎲 Creating and training probes on RANDOM WEIGHTS small-24 model"
echo "Starting at $(date)"

# Create properly randomized version of small-24 model
python -c "
import torch
import numpy as np
...
# Load original model
original_path = 'models/tf_lens_small-24-600K_iters.pth'
random_path = 'models/tf_lens_small-24_RANDOM.pth'

print('🎲 Loading original small-24 model...')
...
echo "🧪 Training probes on randomized small-24 model..."
...
echo "✅ Random small-24 probe training completed at $(date)"