#!/bin/bash
#SBATCH --job-name=random_small16
...
#SBATCH --output=logs/random_small16_%j.out
#SBATCH --error=logs/random_small16_%j.err
...
echo "🎲 Creating and training probes on RANDOM WEIGHTS small-16 model"
echo "Starting at $(date)"

# Create properly randomized version of small-16 model
python -c "
import torch
import numpy as np
...
# Load original model
original_path = 'models/tf_lens_small-16-600k_iters.pth'
random_path = 'models/tf_lens_small-16_RANDOM.pth'

print('🎲 Loading original small-16 model...')
...
echo "🧪 Training probes on randomized small-16 model..."
...
echo "✅ Random small-16 probe training completed at $(date)"